...
#### SmartSourced Content
- SmartSourced Content aims to eliminate the hassle of googling through millions of news, AI facilitated project handles:
  - Fetching the relevant content.
  - Tagging the relevant companies.
  - Assigning the sales triggers i.e. CxO New, M&A etc.
  - Predicting its importance & relevance related to the company.

#### DISC Personality Insights
- Personality driven b2b sales & marketing revolves around personalities, traits etc:
  - Worked on the development of personality engine that takes publicized social media text against the users.
  - Analyze emotions, writing styles etc. to predict DISC personality types.
  - Gives recommendation on how to initiate a conversation based on predicted personality.
  - Results evaluated on F1 score.
...
<p align="center" width="100%">
    <img width="60%" src="https://github.com/talalhassann/talalhassann/blob/main/collage.png">
</p>
